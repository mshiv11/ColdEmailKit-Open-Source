...
const getMetadata = (category: CategoryOne, integration: IntegrationOne): Metadata => {
    ...
    return {
        title: `Free ${name} using ${integration.name}`,
        description: `A curated collection of the best cold email tools ${lcFirst(category.description?.replace(".", "") ?? "")} using ${integration.name}.`,
    }
}
