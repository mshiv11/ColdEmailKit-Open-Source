...
export const metadata: Metadata = {
  ...
  description: `Promote your business or software on ${siteConfig.name} and reach a wide audience of cold email professionals.`,
    ...
    <div className="flex flex-col gap-12 md:gap-14 lg:gap-16">
      <Intro alignment="center">
        ...
        <IntroDescription className="max-w-3xl">
          Promote your business or software and reach a wide audience of cold email professionals.
