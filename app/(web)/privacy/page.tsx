...
export default function PrivacyPage() {
  return (
    <>
      ...
      <Prose>
        <p>
          Your privacy is important to us. This Privacy Policy explains how Cold Email Kit ("we",
          "our", or "us") collects, uses, and safeguards information when you use our website and
        ...
        <p>
          ...
          contact us, or otherwise interact with the Service. It does not cover third-party websites
          or services that we link to.
        </p>

        <h3>Information We Collect</h3>
        <ul>
          <li>
            <strong>Information you provide:</strong> content from the "Submit Tool" flow (e.g.,
            tool name, website, descriptions, pricing), contact messages, and any information
            provided when you communicate with us.
          </li>
          <li>
          ...
          <li>
            <strong>Cookies/local storage:</strong> used to support essential site functionality and
            remember preferences. See "Cookies and Similar Technologies" below.
          </li>
          <li>
            <strong>User-generated content:</strong> reviews or article content you submit (if
            applicable).
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Consent</strong> (e.g., non-essential cookies, optional communications).
          </li>
          <li>
          ...
          <li>
            <strong>Legal obligation</strong> (e.g., responding to lawful requests, record keeping).
          </li>
        </ul>

        <h3>Cookies and Similar Technologies</h3>
        <p>
          We use essential cookies and may use privacy-friendly analytics. You can control cookies
          via your browser settings. Blocking essential cookies may impact site functionality.
        </p>
        ...
        <p>
          Our service providers may process data in countries outside your own. Where required, we
          implement safeguards designed to protect your information in line with applicable laws.
        </p>
        ...
        <p>
          ...
          object to processing of your information, and to portability. You can also withdraw
          consent where processing is based on consent. To exercise these rights, contact{" "}
          <a href="mailto:admin@coldemailkit.com">admin@coldemailkit.com</a>.
        </p>
        <p>
          You may also have the right to lodge a complaint with your local supervisory authority. We
          encourage you to contact us first so we can address your concerns.
        </p>

        <h3>Children's Privacy</h3>
        <p>
          The Service is not directed to children under the age where parental consent is required
          (e.g., 13/16). We do not knowingly collect personal information from children.
        </p>
