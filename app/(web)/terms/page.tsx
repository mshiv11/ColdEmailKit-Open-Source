        ...
        <>
            ...
            <Prose>
                <p>
                    ...
                    website and related services (the "Service"). By accessing or using the Service, you
                    agree to be bound by these Terms.
                </p>

                <h3>Eligibility</h3>
                <p>
                    You may use the Service only if you are capable of forming a binding contract with us
                    and are in compliance with these Terms and all applicable laws.
                </p>

                <h3>Your Content and Submissions</h3>
                <ul>
                    <li>
                        You may submit content such as tool listings, reviews, feedback, or messages
                        ("User Content").
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        reproduce, modify, publish, and display your User Content for operating and improving
                        the Service.
                    </li>
                ...
                <p>
                    ...
                    Except as expressly permitted, you may not copy, modify, distribute, or create
                    derivative works based on the Service.
                </p>

                <h3>Prohibited Conduct</h3>
                <ul>
                    <li>Accessing or using the Service for unlawful purposes or in violation of these Terms.</li>
                    ...
                    <li>Uploading malicious code, engaging in abusive behavior, or violating the rights of others.</li>
                </ul>

                <h3>Third-Party Services and Links</h3>
                <p>
                    The Service may reference or link to third-party websites, tools, or services. We do
                    not control and are not responsible for third-party content or practices. Links are
                    provided for convenience and do not constitute endorsement.
                </p>

                <h3>No Professional Advice</h3>
                <p>
                    Content provided by the Service is for informational purposes only and does not
                    constitute professional advice. You should conduct your own due diligence before
                    making decisions.
                </p>
                ...
                <p>
                    To the maximum extent permitted by law, in no event shall Cold Email Kit or its
                    affiliates be liable for any indirect, incidental, special, consequential, or punitive
                    damages, or any loss of profits or revenues, whether incurred directly or indirectly,
                    or any loss of data, use, goodwill, or other intangible losses resulting from (a) your
                    access to or use of or inability to access or use the Service; (b) any conduct or
                    content of any third party on the Service; or (c) unauthorized access, use, or
                    alteration of your transmissions or content.
                </p>

                <h3>Indemnification</h3>
                <p>
                    You agree to defend, indemnify, and hold harmless Cold Email Kit and its affiliates
                    from and against any claims, liabilities, damages, losses, and expenses, including
                    reasonable attorney fees, arising out of or in any way connected with your use of the
                ...
                <p>
                    ...
                    cause or notice, if we reasonably believe you have violated these Terms or if
                ...
                <p>
                    ...
                    unless otherwise required by law. Venue for any dispute will be in the courts having
                ...
                <p>
                    ...
                    above when changes are made. Your continued use of the Service after any changes
