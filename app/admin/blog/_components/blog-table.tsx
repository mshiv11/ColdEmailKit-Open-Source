    ...
    <div className="space-y-6">
          ...
          posts.map(post => (
            <div key={post._meta.path} className="flex items-center justify-between gap-4 p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="secondary" size="sm" asChild>
                  <Link href={`/admin/blog/${post._meta.path}`}>Edit</Link>
                </Button>

                <Dialog
                  open={deletingSlug === post._meta.path}
      ...
      <div className="p-4 bg-muted/50 rounded-lg border">
        <p className="text-sm text-muted-foreground">
          ...
          Editing here updates the file directly. Changes require a dev server restart to take
          effect.
        </p>
      </div>
    </div>
